            ...
            options.forEach { option ->
                ...
                DropdownMenuItem(
                    ...
                    modifier = Modifier
                        ...
                        .testTag(
                            when (option) {
                                GenderOption.MALE -> "sortMale"
                                AddGenderOption.MALE -> "maleGender"
                                AddGenderOption.FEMALE -> "femaleGender"
                                AddGenderOption.UNISEX -> "unisexGender"
                                GenderOption.FEMALE -> "sortFemale"
                                GenderOption.UNISEX -> "sortUnisex"
                                GenderOption.ALL -> "sortAll"
                                OrderOption.ASC -> "sortASC"
                                OrderOption.DESC -> "sortDESC"
                            }
                        )
                )
            }
